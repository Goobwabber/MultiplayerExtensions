...
namespace MultiplayerExtensions
{
    ...
    public static class Downloader
    {
        ...
        private static async Task<IPreviewBeatmapLevel?> DownloadSong(string hash, CancellationToken cancellationToken)
        {
            ...
            sw.Start();
            byte[] beatmapBytes = await bm.LatestVersion.DownloadZIP(progress:
...
#endif
            string folderPath = Utils.GetSongDirectoryName(bm.ID, bm.Metadata.SongName, bm.Metadata.LevelAuthorName);
